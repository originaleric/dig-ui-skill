...
--dig-bg-soft: #0c0a09;
--dig-surface: #ffffff;
--dig-surface-strong: #f0efed;
--dig-surface-elevated: #ffffff;
--dig-text: #0c0a09;
--dig-text-muted: #4e4e4e;
--dig-text-soft: #777169;
--dig-accent: #292524;
--dig-accent-strong: #0c0a09;
--dig-accent-2: #292524;
--dig-accent-2-strong: #292524;
--dig-border: #e7e5e4;
--dig-border-strong: #d6d3d1;
--dig-grid-line: #f0efed;
--dig-success: #16a34a;
--dig-warning: #f3b64c;
--dig-danger: #dc2626;
--dig-info: #292524;

--dig-font-sans: 'Waldenburg', 'Times New Roman', serif;
