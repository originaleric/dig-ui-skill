...
--dig-bg-soft: #0a0a0a;
--dig-surface: #0a0a0a;
--dig-surface-strong: #0a0a0a;
--dig-surface-elevated: #0a0a0a;
--dig-text: #ffffff;
--dig-text-muted: #dadbdf;
--dig-text-soft: #dadbdf;
--dig-accent: #ffffff;
--dig-accent-strong: #ffffff;
--dig-accent-2: #ffffff;
--dig-accent-2-strong: #ffffff;
--dig-border: #212327;
--dig-border-strong: #212327;
--dig-grid-line: #212327;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #ffffff;

--dig-font-sans: universalSans, Inter, system-ui, -apple-system, sans-serif;
--dig-font-mono: GeistMono, ui-monospace, SFMono-Regular, Menlo, Monaco, monospace;
