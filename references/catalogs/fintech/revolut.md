...
--dig-surface-elevated: #16181a;
--dig-text: #191c1f;
--dig-text-muted: #1f2226;
--dig-text-soft: #1f2226;
--dig-accent: #494fdf;
--dig-accent-strong: #494fdf;
--dig-accent-2: #494fdf;
--dig-accent-2-strong: #494fdf;
--dig-border: rgba(0,0,0,0.1);
--dig-border-strong: #191c1f;
