...
--dig-bg-soft: #ffffff;
--dig-surface: #fafafa;
--dig-surface-strong: #ebebeb;
--dig-surface-elevated: #fafafa;
--dig-text: #262626;
--dig-text-muted: #3c3c3c;
--dig-text-soft: #6b6b6b;
--dig-accent: #1c69d4;
--dig-accent-strong: #0653b6;
--dig-accent-2: #1c69d4;
--dig-accent-2-strong: #1c69d4;
--dig-border: #e6e6e6;
--dig-border-strong: #cccccc;
--dig-grid-line: #e6e6e6;
--dig-success: #22c55e;
--dig-warning: #f59e0b;
--dig-danger: #dc2626;
--dig-info: #1c69d4;

--dig-font-sans: 'BMW Type Next Latin', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
