...
--dig-bg-soft: #181818;
--dig-surface: #303030;
--dig-surface-strong: #303030;
--dig-surface-elevated: #303030;
--dig-text: #ffffff;
--dig-text-muted: #969696;
--dig-text-soft: #666666;
--dig-accent: #da291c;
--dig-accent-strong: #b01e0a;
--dig-accent-2: #da291c;
--dig-accent-2-strong: #da291c;
--dig-border: #303030;
--dig-border-strong: #303030;
...
--dig-font-sans: 'FerrariSans', -apple-system, system-ui, sans-serif;
