...
--dig-bg-soft: #000000;
--dig-surface: #1a1a1a;
--dig-surface-strong: #1a1a1a;
--dig-surface-elevated: #262626;
--dig-text: #ffffff;
--dig-text-muted: #bbbbbb;
--dig-text-soft: #7e7e7e;
--dig-accent: #ffffff;
--dig-accent-strong: #ffffff;
--dig-accent-2: #ffffff;
--dig-accent-2-strong: #ffffff;
--dig-border: #3c3c3c;
--dig-border-strong: #262626;
--dig-grid-line: #3c3c3c;
--dig-success: #0fa336;
--dig-warning: #f4b400;
--dig-danger: #f06a6a;
--dig-info: #ffffff;

--dig-font-sans: BMWTypeNextLatin, sans-serif;
