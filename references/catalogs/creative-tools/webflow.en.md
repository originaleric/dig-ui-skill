...
--dig-text: #080808;
--dig-text-muted: #363636;
--dig-text-soft: #363636;
--dig-accent: #080808;
--dig-accent-strong: #080808;
--dig-accent-2: #080808;
--dig-accent-2-strong: #080808;
--dig-border: #d8d8d8;
--dig-border-strong: #d8d8d8;
--dig-grid-line: #d8d8d8;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #080808;

--dig-font-sans: WF Visual Sans Variable, Inter, system-ui, -apple-system, sans-serif;
--dig-font-mono: WFVisualSans-Mono, Inconsolata, ui-monospace, SFMono-Regular, Menlo, monospace;
