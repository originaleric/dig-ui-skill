...
--dig-bg-soft: #010102;
--dig-surface: #010102;
--dig-surface-strong: #010102;
--dig-surface-elevated: #010102;
--dig-text: #f7f8f8;
--dig-text-muted: #f7f8f8;
--dig-text-soft: #f7f8f8;
--dig-accent: #5e6ad2;
--dig-accent-strong: #5e6ad2;
--dig-accent-2: #5e6ad2;
--dig-accent-2-strong: #5e6ad2;
--dig-border: #23252a;
--dig-border-strong: #34343a;
--dig-grid-line: #23252a;
--dig-success: #27a644;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #5e6ad2;

--dig-font-sans: Linear Display;
--dig-font-mono: Linear Mono;
