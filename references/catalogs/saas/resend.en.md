...
--dig-bg-soft: #000000;
--dig-surface: #0a0a0c;
--dig-surface-strong: #0a0a0c;
--dig-surface-elevated: #101012;
--dig-text: #fcfdff;
--dig-text-muted: rgba(252,253,255,0.86);
--dig-text-soft: rgba(252,253,255,0.86);
--dig-accent: #fcfdff;
--dig-accent-strong: #fcfdff;
--dig-accent-2: #fcfdff;
--dig-accent-2-strong: #fcfdff;
--dig-border: rgba(255,255,255,0.06);
--dig-border-strong: rgba(255,255,255,0.14);
--dig-grid-line: rgba(255,255,255,0.06);
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #fcfdff;

--dig-font-sans: Domaine Display;
--dig-font-mono: Geist Mono;
