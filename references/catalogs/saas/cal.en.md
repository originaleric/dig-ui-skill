...
--dig-bg-soft: #ffffff;
--dig-surface: #f5f5f5;
--dig-surface-strong: #e5e7eb;
--dig-surface-elevated: #f5f5f5;
--dig-text: #111111;
--dig-text-muted: #374151;
--dig-text-soft: #6b7280;
--dig-accent: #111111;
--dig-accent-strong: #242424;
--dig-accent-2: #111111;
--dig-accent-2-strong: #111111;
--dig-border: #e5e7eb;
--dig-border-strong: #e5e7eb;
--dig-grid-line: #f3f4f6;
--dig-success: #10b981;
--dig-warning: #f59e0b;
--dig-danger: #ef4444;
--dig-info: #111111;

--dig-font-sans: Cal Sans, Inter, sans-serif;
