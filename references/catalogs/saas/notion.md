...
--dig-bg-soft: #f6f5f4;
--dig-surface: #f6f5f4;
--dig-surface-strong: #f6f5f4;
--dig-surface-elevated: #f6f5f4;
--dig-text: #1a1a1a;
--dig-text-muted: #bbb8b1;
--dig-text-soft: #bbb8b1;
--dig-accent: #5645d4;
--dig-accent-strong: #5645d4;
--dig-accent-2: #5645d4;
--dig-accent-2-strong: #5645d4;
--dig-border: #e5e3df;
--dig-border-strong: #c8c4be;
--dig-grid-line: #ede9e4;
--dig-success: #1aae39;
--dig-warning: #dd5b00;
--dig-danger: #e03131;
--dig-info: #5645d4;

--dig-font-sans: Notion Sans;
