...
--dig-bg-soft: #2b2622;
--dig-surface: #2b2622;
--dig-surface-strong: #2b2622;
--dig-surface-elevated: #2b2622;
--dig-text: #f7f5f0;
--dig-text-muted: #c9c0ad;
--dig-text-soft: #c9c0ad;
--dig-accent: #f7f5f0;
--dig-accent-strong: #f7f5f0;
--dig-accent-2: #f7f5f0;
--dig-accent-2-strong: #f7f5f0;
--dig-border: #3f3a36;
--dig-border-strong: #3f3a36;
--dig-grid-line: #3f3a36;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #f7f5f0;

--dig-font-sans: Inter, system-ui, -apple-system, Segoe UI, Roboto, sans-serif;
--dig-font-mono: DM Mono, ui-monospace, SFMono-Regular, Menlo, monospace;
