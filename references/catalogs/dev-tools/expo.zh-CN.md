...
--dig-bg-soft: #ffffff;
--dig-surface: #ffffff;
--dig-surface-strong: #f0f0f3;
--dig-surface-elevated: #ffffff;
--dig-text: #171717;
--dig-text-muted: #60646c;
--dig-text-soft: #999999;
--dig-accent: #000000;
--dig-accent-strong: #1a1a1a;
--dig-accent-2: #000000;
--dig-accent-2-strong: #000000;
--dig-border: #f0f0f3;
--dig-border-strong: #dcdee0;
--dig-grid-line: #f5f5f7;
--dig-success: #16a34a;
--dig-warning: #f3b64c;
--dig-danger: #eb8e90;
--dig-info: #000000;

--dig-font-sans: 'Inter', -apple-system, system-ui, sans-serif;
