...
--dig-text: #292827;
--dig-text-muted: #292827;
--dig-text-soft: #292827;
--dig-accent: #1b1938;
--dig-accent-strong: #1b1938;
--dig-accent-2: #1b1938;
--dig-accent-2-strong: #1b1938;
--dig-border: #e8e4dd;
--dig-border-strong: #e8e4dd;
--dig-grid-line: #e8e4dd;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #1b1938;

--dig-font-sans: 'Super Sans VF', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif;
