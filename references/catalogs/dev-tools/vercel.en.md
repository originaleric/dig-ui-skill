...
--dig-text: #171717;
--dig-text-muted: #4d4d4d;
--dig-text-soft: #4d4d4d;
--dig-accent: #171717;
--dig-accent-strong: #171717;
--dig-accent-2: #171717;
--dig-accent-2-strong: #171717;
--dig-border: #ebebeb;
--dig-border-strong: #a1a1a1;
...
--dig-font-sans: Geist, Inter, system-ui, -apple-system, sans-serif;
--dig-font-mono: Geist Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, monospace;
