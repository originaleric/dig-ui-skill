...
--dig-bg-soft: #000000;
--dig-surface: #181818;
--dig-surface-strong: #2a2a2a;
--dig-surface-elevated: #222222;
--dig-text: #ffffff;
--dig-text-muted: #a8a8a8;
--dig-text-soft: #888888;
--dig-accent: #0007cd;
--dig-accent-strong: #0005a3;
--dig-accent-2: #00d4ff;
--dig-accent-2-strong: #7b3aed;
--dig-border: #222222;
--dig-border-strong: #333333;
--dig-grid-line: #1a1a1a;
--dig-success: #33d17a;
--dig-warning: #f3b64c;
--dig-danger: #ff4d4d;
--dig-info: #00d4ff;

--dig-font-sans: 'abcDiatype', ui-sans-serif, system-ui, sans-serif;
--dig-font-mono: 'JetBrains Mono', 'Fira Code', monospace;
