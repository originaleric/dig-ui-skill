...
--dig-text: #161616;
--dig-text-muted: #161616;
--dig-text-soft: #161616;
--dig-accent: #0f62fe;
--dig-accent-strong: #0f62fe;
--dig-accent-2: #0f62fe;
--dig-accent-2-strong: #0f62fe;
--dig-border: #e0e0e0;
--dig-border-strong: #161616;
--dig-grid-line: #e0e0e0;
--dig-success: #24a148;
--dig-warning: #f1c21b;
--dig-danger: #da1e28;
--dig-info: #0f62fe;

--dig-font-sans: IBM Plex Sans;
