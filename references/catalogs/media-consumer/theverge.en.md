...
--dig-bg-soft: #131313;
--dig-surface: #131313;
--dig-surface-strong: #131313;
--dig-surface-elevated: #131313;
--dig-text: #3cffd0;
--dig-text-muted: #3cffd0;
--dig-text-soft: #3cffd0;
--dig-accent: #3cffd0;
--dig-accent-strong: #3cffd0;
--dig-accent-2: #3cffd0;
--dig-accent-2-strong: #3cffd0;
--dig-border: #5200ff;
--dig-border-strong: #5200ff;
--dig-grid-line: #5200ff;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #3cffd0;
