...
--dig-text: #202020;
--dig-text-muted: #3a3a3a;
--dig-text-soft: #3a3a3a;
--dig-accent: #ea2804;
--dig-accent-strong: #ea2804;
--dig-accent-2: #ea2804;
--dig-accent-2-strong: #ea2804;
--dig-border: rgba(32,32,32,0.12);
--dig-border-strong: #202020;
--dig-grid-line: rgba(32,32,32,0.12);
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #ea2804;

--dig-font-sans: rb-freigeist-neue;
--dig-font-mono: jetbrains-mono;
