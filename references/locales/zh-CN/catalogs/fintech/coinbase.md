...
--dig-bg-soft: #ffffff;
--dig-surface: #ffffff;
--dig-surface-strong: #eef0f3;
--dig-surface-elevated: #ffffff;
--dig-text: #0a0b0d;
--dig-text-muted: #5b616e;
--dig-text-soft: #7c828a;
--dig-accent: #0052ff;
--dig-accent-strong: #003ecc;
--dig-accent-2: #0052ff;
--dig-accent-2-strong: #0052ff;
--dig-border: #dee1e6;
--dig-border-strong: #dee1e6;
--dig-grid-line: #eef0f3;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #0052ff;

--dig-font-sans: 'Coinbase Display', -apple-system, system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
