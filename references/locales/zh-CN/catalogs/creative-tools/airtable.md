...
--dig-bg-soft: #ffffff;
--dig-surface: #ffffff;
--dig-surface-strong: #e0e2e6;
--dig-surface-elevated: #ffffff;
--dig-text: #181d26;
--dig-text-muted: #333840;
--dig-text-soft: #41454d;
--dig-accent: #181d26;
--dig-accent-strong: #0d1218;
--dig-accent-2: #181d26;
--dig-accent-2-strong: #181d26;
--dig-border: #dddddd;
--dig-border-strong: #9297a0;
--dig-grid-line: #dddddd;
--dig-success: #006400;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #254fad;

--dig-font-sans: Haas Groot Disp, Haas, sans-serif;
