...
--dig-bg-soft: #f7f7f4;
--dig-surface: #ffffff;
--dig-surface-strong: #e6e5e0;
--dig-surface-elevated: #ffffff;
--dig-text: #26251e;
--dig-text-muted: #5a5852;
--dig-text-soft: #807d72;
--dig-accent: #f54e00;
--dig-accent-strong: #d04200;
--dig-accent-2: #f54e00;
--dig-accent-2-strong: #f54e00;
--dig-border: #e6e5e0;
--dig-border-strong: #cfcdc4;
--dig-grid-line: #efeee8;
--dig-success: #1f8a65;
--dig-warning: #f3b64c;
--dig-danger: #cf2d56;
--dig-info: #f54e00;

--dig-font-sans: 'CursorGothic', system-ui, 'Helvetica Neue', Helvetica, Arial, sans-serif;
