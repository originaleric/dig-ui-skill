...
--dig-bg-soft: #f7f4ed;
--dig-surface: #f7f4ed;
--dig-surface-strong: #f7f4ed;
--dig-surface-elevated: #f7f4ed;
--dig-text: #1c1c1c;
--dig-text-muted: #1c1c1c;
--dig-text-soft: #1c1c1c;
--dig-accent: #3b82f6;
--dig-accent-strong: #3b82f6;
--dig-accent-2: #3b82f6;
--dig-accent-2-strong: #3b82f6;
--dig-border: #eceae4;
--dig-border-strong: #eceae4;
--dig-grid-line: #eceae4;
--dig-success: #37d67a;
--dig-warning: #f3b64c;
--dig-danger: #f06a6a;
--dig-info: #3b82f6;
