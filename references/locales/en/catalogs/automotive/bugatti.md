...
--dig-bg-soft: #000000;
--dig-surface: #141414;
--dig-surface-strong: #141414;
--dig-surface-elevated: #1f1f1f;
--dig-text: #ffffff;
--dig-text-muted: #cccccc;
...
--dig-border: #262626;
--dig-border-strong: #3a3a3a;
--dig-grid-line: #262626;
--dig-success: #5fa657;
--dig-warning: #d4a017;
--dig-danger: #f06a6a;
--dig-info: #ffffff;

--dig-font-sans: Bugatti Display, sans-serif;
